  ...
  const filteredBranches = useMemo(() => {
    return branches.filter(b => {
      const matchesSearch =
        ...
        (b.solId && b.solId.toLowerCase().includes(branchSearch.toLowerCase())) ||
        (b.code && b.code.toLowerCase().includes(branchSearch.toLowerCase())) ||
        (b.districtName && b.districtName.toLowerCase().includes(branchSearch.toLowerCase())) ||
        (b.phone && b.phone.toLowerCase().includes(branchSearch.toLowerCase())) ||
  ...
  const filteredDistricts = useMemo(() => {
    return districts.filter(d => {
      const matchesSearch =
        ...
        (d.solId && d.solId.toLowerCase().includes(districtSearch.toLowerCase())) ||
