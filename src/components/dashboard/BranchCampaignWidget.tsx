...
export const BranchCampaignWidget: React.FC<BranchCampaignWidgetProps> = ({
  ...
  const totals = filtered.reduce(
    (acc, r) => ({
      customerBase: acc.customerBase + (r.accountOpenings || 0),
      mobileBanking: acc.mobileBanking + (r.mobileBankingActivations || 0),
      internetBanking: acc.internetBanking + (r.internetBankingActivations || 0),
      atmCards: acc.atmCards + (r.atmCardActivations || 0),
      merchants: acc.merchants + (r.merchantSolutions || 0),
      deposits: acc.deposits + (r.depositsETB || 0)
    }),
